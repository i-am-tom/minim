...
var $author$project$Minim$Model$A = {$: 'A'};
var $author$project$Minim$Model$Ab = {$: 'Ab'};
var $author$project$Minim$Model$B = {$: 'B'};
var $author$project$Minim$Model$Bb = {$: 'Bb'};
var $author$project$Minim$Model$C = {$: 'C'};
var $author$project$Minim$Model$D = {$: 'D'};
var $author$project$Minim$Model$Db = {$: 'Db'};
var $author$project$Minim$Model$E = {$: 'E'};
var $author$project$Minim$Model$Eb = {$: 'Eb'};
var $author$project$Minim$Model$F = {$: 'F'};
var $author$project$Minim$Note$Flat = {$: 'Flat'};
var $author$project$Minim$Model$G = {$: 'G'};
var $author$project$Minim$Model$Gb = {$: 'Gb'};
var $author$project$Minim$Model$Menu = function (a) {
	return {$: 'Menu', a: a};
};
var $elm$core$Maybe$Nothing = {$: 'Nothing'};
var $author$project$Minim$Update$PressKeys = function (a) {
	return {$: 'PressKeys', a: a};
};
var $author$project$Minim$Update$RequestNewGame = {$: 'RequestNewGame'};
var $author$project$Minim$Update$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$Minim$Keyboard$label = function (note) {
	switch (note.$) {
		case 'C':
			return 'A';
		case 'Db':
...
var $author$project$Minim$Note$print = F2(
...
var $author$project$Main$accidental = F3(
	function (highlights, index, note) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					'key-' + A2($author$project$Minim$Note$print, $author$project$Minim$Note$Flat, note)),
					$elm$html$Html$Attributes$class(
					A2($elm$core$List$member, note, highlights) ? 'key-active' : '')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Minim$Keyboard$label(note))
				]));
	});
...
var $author$project$Main$natural = F3(
	function (highlights, index, note) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Minim$Interval$print = function (interval) {
	switch (interval.$) {
		case 'Minor2nd':
			return 'a half step / minor 2nd';
		case 'Major2nd':
			return 'a whole step / major 2nd';
		case 'Minor3rd':
			return 'a minor 3rd';
		case 'Major3rd':
			return 'a major 3rd';
		case 'Perfect4th':
			return 'a perfect 4th';
		case 'Tritone':
			return 'a tritone / augmented 4th / diminished 5th';
		case 'Perfect5th':
			return 'a perfect 5th';
		case 'Minor6th':
			return 'a minor 6th / augmented 5th';
		case 'Major6th':
			return 'a major 6th';
		case 'Minor7th':
			return 'a minor 7th / augmented 6th';
		case 'Major7th':
			return 'a major 7th';
		default:
			return 'an octave';
...
var $author$project$Minim$Test$print = function (test) {
	if (test.$ === 'AbsoluteIntervalTest') {
		var note = test.a;
		var direction = test.b;
		var interval = test.c;
		if (direction.$ === 'Down') {
			return 'Transpose ' + ($author$project$Minim$Interval$print(interval) + (' below ' + A2($author$project$Minim$Note$print, $author$project$Minim$Note$Flat, note)));
		} else {
			return 'Transpose ' + ($author$project$Minim$Interval$print(interval) + (' above ' + A2($author$project$Minim$Note$print, $author$project$Minim$Note$Flat, note)));
		}
	} else {
		var note = test.a;
		var chord = test.b;
		switch (chord.$) {
			case 'Major':
				return 'Select the 3rd and 7th of ' + (A2($author$project$Minim$Note$print, $author$project$Minim$Note$Flat, note) + 'Δ');
			case 'Minor':
				return 'Select the 3rd and 7th of ' + (A2($author$project$Minim$Note$print, $author$project$Minim$Note$Flat, note) + '-7');
			default:
				return 'Select the 3rd and 7th of ' + (A2($author$project$Minim$Note$print, $author$project$Minim$Note$Flat, note) + '7');
		}
	}
...
var $author$project$Minim$Update$AssignTest = function (a) {
	return {$: 'AssignTest', a: a};
};
var $author$project$Minim$Model$Correct = {$: 'Correct'};
var $author$project$Minim$Update$EndGame = function (a) {
	return {$: 'EndGame', a: a};
};
var $ohanhi$keyboard$Keyboard$Enter = {$: 'Enter'};
var $author$project$Minim$Model$ShouldHaveBeen = function (a) {
	return {$: 'ShouldHaveBeen', a: a};
};
var $author$project$Minim$Update$StartGame = function (a) {
	return {$: 'StartGame', a: a};
};
var $author$project$Minim$Model$Testing = function (a) {
	return {$: 'Testing', a: a};
};
var $author$project$Minim$Update$Validate = {$: 'Validate'};
...
var $author$project$Minim$Model$AbsoluteIntervalTest = F3(
	function (a, b, c) {
		return {$: 'AbsoluteIntervalTest', a: a, b: b, c: c};
	});
var $author$project$Minim$Model$Dominant = {$: 'Dominant'};
var $author$project$Minim$Model$Down = {$: 'Down'};
var $author$project$Minim$Model$Major = {$: 'Major'};
var $author$project$Minim$Model$Major2nd = {$: 'Major2nd'};
var $author$project$Minim$Model$Major3rd = {$: 'Major3rd'};
var $author$project$Minim$Model$Major6th = {$: 'Major6th'};
var $author$project$Minim$Model$Major7th = {$: 'Major7th'};
var $author$project$Minim$Model$Minor = {$: 'Minor'};
var $author$project$Minim$Model$Minor2nd = {$: 'Minor2nd'};
var $author$project$Minim$Model$Minor3rd = {$: 'Minor3rd'};
var $author$project$Minim$Model$Minor6th = {$: 'Minor6th'};
var $author$project$Minim$Model$Minor7th = {$: 'Minor7th'};
var $author$project$Minim$Model$Octave = {$: 'Octave'};
var $author$project$Minim$Model$Perfect4th = {$: 'Perfect4th'};
var $author$project$Minim$Model$Perfect5th = {$: 'Perfect5th'};
var $author$project$Minim$Model$Tritone = {$: 'Tritone'};
var $author$project$Minim$Model$TwoNoteVoicingTest = F2(
	function (a, b) {
		return {$: 'TwoNoteVoicingTest', a: a, b: b};
	});
var $author$project$Minim$Model$Up = {$: 'Up'};
...
var $author$project$Minim$Test$random = function () {
	var note = A2(
		$elm$random$Random$uniform,
		$author$project$Minim$Model$C,
		_List_fromArray(
			[$author$project$Minim$Model$Db, $author$project$Minim$Model$D, $author$project$Minim$Model$Eb, $author$project$Minim$Model$E, $author$project$Minim$Model$F, $author$project$Minim$Model$Gb, $author$project$Minim$Model$G, $author$project$Minim$Model$Ab, $author$project$Minim$Model$A, $author$project$Minim$Model$Bb, $author$project$Minim$Model$B]));
	var interval = A2(
		$elm$random$Random$uniform,
		$author$project$Minim$Model$Minor2nd,
		_List_fromArray(
			[$author$project$Minim$Model$Major2nd, $author$project$Minim$Model$Minor3rd, $author$project$Minim$Model$Major3rd, $author$project$Minim$Model$Perfect4th, $author$project$Minim$Model$Tritone, $author$project$Minim$Model$Perfect5th, $author$project$Minim$Model$Minor6th, $author$project$Minim$Model$Major6th, $author$project$Minim$Model$Minor7th, $author$project$Minim$Model$Major7th, $author$project$Minim$Model$Octave]));
	var direction = A2(
		$elm$random$Random$uniform,
		$author$project$Minim$Model$Up,
		_List_fromArray(
			[$author$project$Minim$Model$Down]));
	var chord = A2(
		$elm$random$Random$uniform,
		$author$project$Minim$Model$Major,
		_List_fromArray(
			[$author$project$Minim$Model$Minor, $author$project$Minim$Model$Dominant]));
	var twoNoteVoicing = A3($elm$random$Random$map2, $author$project$Minim$Model$TwoNoteVoicingTest, note, chord);
	var absoluteInterval = A4($elm$random$Random$map3, $author$project$Minim$Model$AbsoluteIntervalTest, note, direction, interval);
	return A2(
...
var $author$project$Minim$Test$intToNote = function (_int) {
	intToNote:
	while (true) {
		switch (_int) {
			case 0:
				return $author$project$Minim$Model$C;
			case 1:
				return $author$project$Minim$Model$Db;
			case 2:
				return $author$project$Minim$Model$D;
			case 3:
				return $author$project$Minim$Model$Eb;
			case 4:
				return $author$project$Minim$Model$E;
			case 5:
				return $author$project$Minim$Model$F;
			case 6:
				return $author$project$Minim$Model$Gb;
			case 7:
				return $author$project$Minim$Model$G;
			case 8:
				return $author$project$Minim$Model$Ab;
			case 9:
				return $author$project$Minim$Model$A;
			case 10:
				return $author$project$Minim$Model$Bb;
			case 11:
				return $author$project$Minim$Model$B;
			default:
				var overflow = _int;
				var $temp$int = A2($elm$core$Basics$modBy, 12, overflow);
				_int = $temp$int;
				continue intToNote;
		}
	}
};
var $author$project$Minim$Test$intervalToInt = function (interval) {
	switch (interval.$) {
		case 'Minor2nd':
			return 1;
		case 'Major2nd':
...
var $author$project$Minim$Note$toInt = function (note) {
	switch (note.$) {
		case 'C':
			return 0;
		case 'Db':
...
var $author$project$Minim$Test$solve = function (test) {
	if (test.$ === 'AbsoluteIntervalTest') {
		var note = test.a;
		var direction = test.b;
		var interval = test.c;
		return _List_fromArray(
			[
				function () {
				if (direction.$ === 'Up') {
					return $author$project$Minim$Test$intToNote(
						$author$project$Minim$Note$toInt(note) + $author$project$Minim$Test$intervalToInt(interval));
				} else {
					return $author$project$Minim$Test$intToNote(
						$author$project$Minim$Note$toInt(note) - $author$project$Minim$Test$intervalToInt(interval));
				}
		...
		switch (chord.$) {
			case 'Major':
				return _List_fromArray(
					[
						$author$project$Minim$Test$intToNote(
						$author$project$Minim$Note$toInt(note) + $author$project$Minim$Test$intervalToInt($author$project$Minim$Model$Major3rd)),
						$author$project$Minim$Test$intToNote(
						$author$project$Minim$Note$toInt(note) + $author$project$Minim$Test$intervalToInt($author$project$Minim$Model$Major7th))
					]);
			case 'Minor':
				return _List_fromArray(
					[
						$author$project$Minim$Test$intToNote(
						$author$project$Minim$Note$toInt(note) + $author$project$Minim$Test$intervalToInt($author$project$Minim$Model$Minor3rd)),
						$author$project$Minim$Test$intToNote(
						$author$project$Minim$Note$toInt(note) + $author$project$Minim$Test$intervalToInt($author$project$Minim$Model$Minor7th))
					]);
			default:
				return _List_fromArray(
					[
...
var $author$project$Minim$Keyboard$read = function (key) {
	_v0$12:
	while (true) {
		if (key.$ === 'Character') {
			switch (key.a) {
				case 'A':
					return $elm$core$Maybe$Just($author$project$Minim$Model$C);
				case 'W':
					return $elm$core$Maybe$Just($author$project$Minim$Model$Db);
				case 'S':
					return $elm$core$Maybe$Just($author$project$Minim$Model$D);
				case 'E':
					return $elm$core$Maybe$Just($author$project$Minim$Model$Eb);
				case 'D':
					return $elm$core$Maybe$Just($author$project$Minim$Model$E);
				case 'F':
					return $elm$core$Maybe$Just($author$project$Minim$Model$F);
				case 'T':
					return $elm$core$Maybe$Just($author$project$Minim$Model$Gb);
				case 'G':
					return $elm$core$Maybe$Just($author$project$Minim$Model$G);
				case 'Y':
					return $elm$core$Maybe$Just($author$project$Minim$Model$Ab);
				case 'H':
					return $elm$core$Maybe$Just($author$project$Minim$Model$A);
				case 'U':
					return $elm$core$Maybe$Just($author$project$Minim$Model$Bb);
				case 'J':
					return $elm$core$Maybe$Just($author$project$Minim$Model$B);
				default:
					break _v0$12;
			}
		} else {
...
var $author$project$Minim$Update$updateKeys = F2(
	function (newKeys, currentNotes) {
		var toggler = F2(
			function (newNote, acc) {
				return A2($elm$core$List$member, newNote, acc) ? A2(
					$elm$core$List$filter,
					function (x) {
						return !_Utils_eq(x, newNote);
					},
					acc) : A2($elm$core$List$cons, newNote, acc);
			});
		var newNotes = A2($elm$core$List$filterMap, $author$project$Minim$Keyboard$read, newKeys);
		return A3($elm$core$List$foldr, toggler, currentNotes, newNotes);
	});
var $author$project$Minim$Update$update = F2(
		...
		while (true) {
			switch (message.$) {
				case 'RequestNewGame':
					return _Utils_Tuple2(
						model,
						A2($elm$core$Task$perform, $author$project$Minim$Update$StartGame, $elm$time$Time$now));
				case 'StartGame':
					var now = message.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								_interface: $author$project$Minim$Model$Testing(
									{currentScore: 0, currentTime: now, keyboard: _List_Nil, lastResult: $elm$core$Maybe$Nothing, startTime: now, test: $elm$core$Maybe$Nothing})
							}),
						A2($elm$random$Random$generate, $author$project$Minim$Update$AssignTest, $author$project$Minim$Test$random));
				case 'Allow':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								challenges: A2($elm$core$List$cons, challenge, model.challenges)
							}),
				...
				case 'Tick':
					var tick = message.a;
					var _v1 = model._interface;
					if (_v1.$ === 'Menu') {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
						var testingModel = _v1.a;
						...
						var startTime = $elm$time$Time$posixToMillis(testingModel.startTime);
						var currentTime = $elm$time$Time$posixToMillis(tick);
						if (A2($elm$core$Debug$log, 'duration', currentTime - startTime) >= 180000) {
							var $temp$message = $author$project$Minim$Update$EndGame(testingModel.currentScore),
								$temp$model = updated;
				...
				case 'AssignTest':
					var test = message.a;
					var _v2 = model._interface;
					if (_v2.$ === 'Testing') {
						var testingModel = _v2.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
				...
				case 'PressKeys':
					var msg = message.a;
					var newKeys = A2($ohanhi$keyboard$Keyboard$update, msg, model.pressedKeys);
					var updated = _Utils_update(
						model,
						{pressedKeys: newKeys});
					if (_Utils_eq(
						...
						var $temp$message = $author$project$Minim$Update$Validate,
							$temp$model = updated;
						message = $temp$message;
						model = $temp$model;
						continue update;
					} else {
						var _v3 = model._interface;
						if (_v3.$ === 'Menu') {
							return _Utils_Tuple2(updated, $elm$core$Platform$Cmd$none);
						} else {
							var testingModel = _v3.a;
							var selection = A2($author$project$Minim$Update$updateKeys, newKeys, testingModel.keyboard);
							return _Utils_Tuple2(
								_Utils_update(
									updated,
									{
				...
				case 'Validate':
					var _v4 = model._interface;
					if (_v4.$ === 'Menu') {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
						var testingModel = _v4.a;
						var _v5 = testingModel.test;
						if (_v5.$ === 'Just') {
							var test = _v5.a;
							var guess = A2($elm$core$List$sortBy, $author$project$Minim$Note$toInt, testingModel.keyboard);
							var check = A2(
								$elm$core$List$sortBy,
								$author$project$Minim$Note$toInt,
								$author$project$Minim$Test$solve(test));
							var updated = _Utils_eq(guess, check) ? _Utils_update(
								testingModel,
								{
									currentScore: testingModel.currentScore + 1,
									keyboard: _List_Nil,
									lastResult: $elm$core$Maybe$Just($author$project$Minim$Model$Correct),
									test: $elm$core$Maybe$Nothing
								}) : _Utils_update(
								testingModel,
								{
									keyboard: _List_Nil,
									lastResult: $elm$core$Maybe$Just(
										$author$project$Minim$Model$ShouldHaveBeen(check)),
									test: $elm$core$Maybe$Nothing
								});
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										_interface: $author$project$Minim$Model$Testing(updated)
									}),
								A2($elm$random$Random$generate, $author$project$Minim$Update$AssignTest, $author$project$Minim$Test$random));
						} else {
							return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				...
				default:
					...
					var updated = _Utils_update(
						model,
						{
							_interface: $author$project$Minim$Model$Menu(
								{
									lastScore: $elm$core$Maybe$Just(score)
								})
						});
					return (_Utils_cmp(model.highscore, score) < 0) ? _Utils_Tuple2(
						_Utils_update(
							updated,
							{highscore: score}),
						$elm$core$Platform$Cmd$none) : _Utils_Tuple2(updated, $elm$core$Platform$Cmd$none);
			}
		}
	});
var $author$project$Main$main = $elm$browser$Browser$element(
	{
			...
			return _Utils_Tuple2(
				{
					...
					highscore: 0,
					_interface: $author$project$Minim$Model$Menu(
						{lastScore: $elm$core$Maybe$Nothing}),
		...
		subscriptions: function (model) {
			return $elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						A2($elm$core$Platform$Sub$map, $author$project$Minim$Update$PressKeys, $ohanhi$keyboard$Keyboard$subscriptions),
						function () {
						var _v1 = model._interface;
						if (_v1.$ === 'Menu') {
							return $elm$core$Platform$Sub$none;
						} else {
							return A2($elm$time$Time$every, 1000, $author$project$Minim$Update$Tick);
						}
					}()
					]));
		},
		update: $author$project$Minim$Update$update,
		view: function (model) {
			var _v2 = model._interface;
			if (_v2.$ === 'Menu') {
				var menuModel = _v2.a;
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('previous-score')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Previous score: '),
											A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('high-score')
										]),
									_List_fromArray(
										[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onSubmit($author$project$Minim$Update$RequestNewGame)
								]),
							_List_fromArray(
								[
									A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Remaining time: '),
									A2(
									$elm$html$Html$span,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											function () {
											var start = $elm$time$Time$posixToMillis(testingModel.startTime);
											var current = $elm$time$Time$posixToMillis(testingModel.currentTime);
											var remainder = 180 - (((current - start) / 1000) | 0);
											return $elm$html$Html$text(
												$elm$core$String$fromInt(remainder));
										}()
										]))
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('naturals')
										]),
									A2(
										$elm$core$List$indexedMap,
										$author$project$Main$natural(testingModel.keyboard),
										_List_fromArray(
											[$author$project$Minim$Model$C, $author$project$Minim$Model$D, $author$project$Minim$Model$E, $author$project$Minim$Model$F, $author$project$Minim$Model$G, $author$project$Minim$Model$A, $author$project$Minim$Model$B]))),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('accidentals')
										]),
									A2(
										$elm$core$List$indexedMap,
										$author$project$Main$accidental(testingModel.keyboard),
										_List_fromArray(
											[$author$project$Minim$Model$Db, $author$project$Minim$Model$Eb, $author$project$Minim$Model$Gb, $author$project$Minim$Model$Ab, $author$project$Minim$Model$Bb])))
								])),
							function () {
							var _v4 = testingModel.test;
							if (_v4.$ === 'Just') {
								var test = _v4.a;
								return A2(
									$elm$html$Html$div,
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											$author$project$Minim$Test$print(test))
										]));
							} else {
								return $elm$html$Html$text('');
							}
							...
							function () {
							var _v5 = testingModel.lastResult;
							if (_v5.$ === 'Nothing') {
								return $elm$html$Html$text('');
							} else {
								if (_v5.a.$ === 'Correct') {
									...
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('result correct')
											]),
										_List_fromArray(
											[
									...
									var notes = A2(
										$elm$core$List$map,
										$author$project$Minim$Note$print($author$project$Minim$Note$Flat),
										answers);
									return A2(
										$elm$html$Html$div,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('result incorrect')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Oops! The correct answer was: '),
												$elm$html$Html$text(
												A2($elm$core$String$join, ', ', notes))
											]));
								}
							}
						}(),
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('current-score')
								]),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											$elm$core$String$fromInt(testingModel.currentScore))
										]))
								]))
						]));
			}
